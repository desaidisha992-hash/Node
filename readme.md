...
// })
// issue: every time you run the file that put new data with exiting data, so that print same data every time you run tha file
// fs.wirteFile(path, data, cb fnc)
...
// read file
// fs.readFile(path, cb fnc(e, data){})
...
// rename folder
// fs.rename("CSS/Home/Component", "CSS/Home/Component", (e)=>{
//     if(e) throw error;
