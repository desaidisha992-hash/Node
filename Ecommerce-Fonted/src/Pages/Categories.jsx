      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-20">
          ...
          <div 
            ...
            className="h-1 bg-luxury-gold mx-auto mb-8"
          ></div>
          <p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {categories.filter(c => c.name.toLowerCase().includes(searchTerm.toLowerCase())).map((category, index) => (
              <div
                ...
                whileHover={{ y: -10 }}
                className="group relative h-600p overflow-hidden rounded-none bg-luxury-navy"
              >
                <img 
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-luxury-navy via-transparent to-transparent opacity-80"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              <div className="flex items-center space-x-4">
                <div className="w-10 h-1p bg-luxury-gold"></div>
