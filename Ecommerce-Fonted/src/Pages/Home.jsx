    ...
    <div className="bg-luxury-gold-light min-h-screen">
      ...
      <section className="relative h-[95vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-luxury-navy/60 via-transparent to-transparent"></div>
        </div>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center">
          <div className="w-1 h-20 bg-linear-to-b from-white/20 to-luxury-gold animate-bounce"></div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div whileHover={{ scale: 0.98 }} className="h-75 sm:h-125 rounded-none overflow-hidden relative group">
            ...
            <div whileHover={{ scale: 0.98 }} className="h-75 sm:h-100 sm:mt-24 rounded-none overflow-hidden relative group">
      ...
      <section className="py-20 md:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="relative h-100 md:h-150 flex items-center justify-center overflow-hidden">
          <img 
